      ...
      <div className="bg-white rounded-xl w-full max-w-sm p-4 shadow-lg">
        ...
        <form onSubmit={handleSubmit} className="grid gap-2">
          ...
          <FormField label="Género">
            <input className="w-full px-3 py-2 border border-gray-300 rounded-lg" value={genre} onChange={(e) => setGenre(e.target.value)} />
          </FormField>
          ...
          <div className="flex items-center gap-2 justify-end mt-2">
            <button type="button" onClick={onClose} className="px-3 py-2 rounded-lg border border-gray-300">Cancelar</button>
